...
@section('container')
    <center>
        <h1 class="text-muted text-uppercase mt-4">Edit Vehicle</h1>
    </center>
    <div class="col-lg-20">
        <form method="POST" action="{{ route('edit.post', ['vehicle' => $vehicle->id]) }}">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" aria-label="Default select example" id="service_schedule"
                    name="service_schedule" value="{{ $vehicle->service_schedule }}">
