...
@section('container')
    <center>
        <h1 class="text-muted text-uppercase mt-4">Edit Vehicle Approval</h1>
    </center>
    <div class="col-lg-20">
        <form method="POST" action="{{ route('editapproval.post', ['vehicle_approval' => $vehicle_approval->id]) }}">
            @csrf
            <div class="mb-3">
